#below create a word cloud visualization
import sqlite3
import time
import zlib
import string
...
for message_row in cur :
    ...
    text = text.translate(str.maketrans('','',string.punctuation)) #throw away punctuation and numbers
...
#C:\Users\Jerry\machine-learning-ex1\Python3\py4e\gmane>py gword.py
#Range of counts: 4210 122
